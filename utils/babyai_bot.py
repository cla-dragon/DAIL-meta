...
class GoNextToSubgoal(Subgoal):
    ...
    def replan_before_action(self):
        ...
        if np.array_equal(np.array(next_cell) - np.array(self.pos), self.right_vec):
            return self.actions.right
        elif np.array_equal(np.array(next_cell) - np.array(self.pos), -self.right_vec):
            return self.actions.left
...
class Bot:
    ...
    def _process_obs(self):
        ...
        pos = np.array(self.mission.agent_pos)
